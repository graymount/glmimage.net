...
export async function getSettingGroups() {
  ...
  const settingGroups: SettingGroup[] = [
    ...
    {
      name: 'image_models',
      title: t('groups.image_models'),
      description: 'Configure image generation models for multi-model comparison',
      tab: 'ai',
    },
    {
      name: 'adsense',
...
export async function getSettings() {
  const settings: Setting[] = [
    ...
    },
    {
      ...
      type: 'text',
      value: 'Welcome to GLM Image! Free credits to get started.',
  ...
  "premium-yearly": "prod_xxx"
    ...
    {
      name: 'image_models_enabled',
      title: 'Enabled Models',
      type: 'checkbox',
      tip: 'Select models for multi-model comparison generation (4-6 recommended)',
      options: [
        { title: 'Flux Pro 1.1 (Photorealistic)', value: 'fal-ai/flux-pro/v1.1' },
        { title: 'Flux Dev (Balanced)', value: 'fal-ai/flux/dev' },
        { title: 'Flux Schnell (Fast)', value: 'fal-ai/flux/schnell' },
        { title: 'Recraft V3 (Design)', value: 'fal-ai/recraft-v3' },
        { title: 'Ideogram V2 (Typography)', value: 'fal-ai/ideogram/v2' },
        { title: 'Stable Diffusion 3.5 Large', value: 'fal-ai/stable-diffusion-v35-large' },
      ],
      value: ['fal-ai/flux-pro/v1.1', 'fal-ai/flux/dev', 'fal-ai/recraft-v3', 'fal-ai/ideogram/v2'],
      group: 'image_models',
      tab: 'ai',
    },
    {
